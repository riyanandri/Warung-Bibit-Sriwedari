    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="{{ route('shop') }}" class="nav-link">Belanja</a></li>
                @auth
                <li class="nav-item"><a href="{{ route('wishlist') }}" class="nav-link">Disukai</a></li>
                <li class="nav-item"><a href="{{ route('order') }}" class="nav-link">Pesanan</a></li>
