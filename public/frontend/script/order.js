$(document).ready(function () {
    ...
    $('body').on('click', '#cancel', function (e) {
        ...
        swal({
                title: "Anda yakin?",
                text: "Setelah dibatalkan, Anda tidak akan dapat melakukan pembayaran atas pesanan ini!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        success: function (response) {
                            swal("Pesanan Anda telah berhasil dibatalkan!", {
                                icon: "success",
                            }).then((success) => {
                                if (success) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.redirect == true) {
                    swal("Pesanan Anda telah dibayar!", {
                        icon: "warning",
                    }).then((success) => {
                        if (success) {
                            window.location.reload();
                ...
                snap.pay(response.snapToken, {
                    onSuccess: function (result) {
                        $.ajax({
                            ...
                            dataType: "json",
                            success: function (response) {
                                swal("Pesanan anda telah berhasil dibayar!", {
                                    icon: "success",
                                }).then((success) => {
                                    if (success) {
                                        window.location.reload();
